...
const MENU = {
  fuertes: [
    ...
    { id: 'pasta_ckocko',      name: 'Pasta al Ckocko de Pollo',  price: 65,  img: 'picantemixto',        desc: 'Pasta artesanal bañada en salsa de ckocko, maní tostado y pollo desmechado. Donde la tradición abraza la contemporaneidad.',     hero: 'square' },
  ...
  picantes: [
    { id: 'mondongo',          name: 'Mondongo',                  price: 55,  img: 'picantemixto',        desc: 'Estómago de cerdo en ají colorado, cocinado a fuego lento con mote y palillo. Sabor profundo de nuestra gastronomía.',          hero: 'square' },
    ...
    { id: 'picante_lengua',    name: 'Picante de Lengua',         price: 80,  img: 'picantemixto',        desc: 'Lengua de res tiernizada en salsa de ají amarillo y rojo, con tallarín artesanal. Una preparación que requiere paciencia.',     hero: 'square' },
